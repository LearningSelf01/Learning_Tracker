...
class AdminStudentAdmissionPage extends StatefulWidget {
  const AdminStudentAdmissionPage({super.key});

  @override
  State<AdminStudentAdmissionPage> createState() => _AdminStudentAdmissionPageState();
}
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // List below filters (replacing grid with ListView)
        Expanded(
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return Card(
                elevation: 1,
                child: ListTile(
                  title: Text('Admission Item #${index + 1}'),
                  onTap: () {},
                ),
              );
            },

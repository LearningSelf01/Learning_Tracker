...
class AdminStudentUpdationPage extends StatefulWidget {
  const AdminStudentUpdationPage({super.key});

  @override
  State<AdminStudentUpdationPage> createState() => _AdminStudentUpdationPageState();
}
...
class _AdminStudentUpdationPageState extends State<AdminStudentUpdationPage> {
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return Card(
                elevation: 1,
                child: ListTile(
                  title: Text('Student Update #${index + 1}'),
                  onTap: () {},
                ),
              );
            },

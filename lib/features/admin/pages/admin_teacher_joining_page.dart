...
class AdminTeacherJoiningPage extends StatefulWidget {
  const AdminTeacherJoiningPage({super.key});

  @override
  State<AdminTeacherJoiningPage> createState() => _AdminTeacherJoiningPageState();
}

class _AdminTeacherJoiningPageState extends State<AdminTeacherJoiningPage> {
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return Card(
                elevation: 1,
                child: ListTile(
                  title: Text('Teacher Joining #${index + 1}'),
                  onTap: () {},
                ),
              );
            },

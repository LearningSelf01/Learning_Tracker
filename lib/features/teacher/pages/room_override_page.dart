...
import '../../../features/student/data/routine_repository.dart';

class TeacherRoomOverridePage extends StatefulWidget {
  const TeacherRoomOverridePage({super.key});

  @override
  State<TeacherRoomOverridePage> createState() => _TeacherRoomOverridePageState();
}

class _TeacherRoomOverridePageState extends State<TeacherRoomOverridePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Room Override (Teacher)')),
      body: Padding(
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        return ListTile(
                          ...
                          onTap: () {
                            // Placeholder: no persistence implemented; just show that we "saved"
